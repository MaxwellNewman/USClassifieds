...
public class SignInTests {
    ...
    private static final String BAD_ACCOUNT_NAME = "Bad Account Name";
    private static final String BAD_EMAIL = "bademail@usc.edu";
    ...
    //these tests are repetitive, but it is better to split them into multiple tests
    //so that we would be identify the problem(s) based on the test results
    @Test
    public void CreateExistingAccountTest1() throws InterruptedException {
    ...
    @Test
    public void CreateExistingAccountTest2() throws InterruptedException {
        //click on create account button
        onView(withId(R.id.textView8)).perform(click());
        ...
        onView(withId(R.id.createUsername)).perform(replaceText(USERNAME));
        onView(withId(R.id.createPassword)).perform(replaceText(PASSWORD));
        onView(withId(R.id.createEmail)).perform(replaceText(BAD_EMAIL));
        onView(withId(R.id.createName)).perform(replaceText(ACCOUNT_NAME));
        onView(withId(R.id.createButton)).perform(click());
    ...
    @Test
    public void CreateExistingAccountTest3() throws InterruptedException {
        //click on create account button
        onView(withId(R.id.textView8)).perform(click());

        //type in account info and hit submit
        onView(withId(R.id.createUsername)).perform(replaceText(BAD_USERNAME));
        onView(withId(R.id.createPassword)).perform(replaceText(PASSWORD));
        onView(withId(R.id.createEmail)).perform(replaceText(EMAIL));
        onView(withId(R.id.createName)).perform(replaceText(ACCOUNT_NAME));
        onView(withId(R.id.createButton)).perform(click());
    ...
    @Test
    public void CreateExistingAccountTest4() throws InterruptedException {
        //click on create account button
        onView(withId(R.id.textView8)).perform(click());
        ...
        onView(withId(R.id.createPassword)).perform(replaceText(PASSWORD));
        onView(withId(R.id.createEmail)).perform(replaceText(EMAIL));
        onView(withId(R.id.createName)).perform(replaceText(BAD_ACCOUNT_NAME));
        onView(withId(R.id.createButton)).perform(click());
